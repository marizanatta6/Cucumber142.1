...
public class ComprarProdutoBDD {
   ...
   @Quando("aperto botao Continue")
   public void aperto_botao_continue() {
       checkoutPage.clicarContinue();
   }

   @Entao("olho se os dados estao certos")
   public void olho_se_os_dados_estao_certos() {
       assertTrue(checkoutPage.dadosEstaoCorretos(), "Os dados não estão corretos");
   }
